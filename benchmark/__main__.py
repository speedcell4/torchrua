...
from benchmark.reduction import reduce_catted_sequence, reduce_packed_sequence, reduce_padded_sequence, \
    reduce_packed_sequence2, reduce_catted_sequence2, reduce_padded_sequence2
...
app.option(reduce_packed_sequence2)
app.option(reduce_padded_sequence)
app.option(reduce_padded_sequence2)
app.option(reduce_catted_sequence)
app.option(reduce_catted_sequence2)
