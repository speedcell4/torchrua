...
from benchmark.reverse_packed_sequence import reverse_packed_sequence_fn
from benchmark.roll_packed_sequence import roll_packed_sequence_fn

app = App()

app.register(reverse_packed_sequence_fn)
app.register(roll_packed_sequence_fn)
