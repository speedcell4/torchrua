...
from torchrua import cat_sequence, pad_catted_sequence
from torchrua import pack_sequence
from torchrua import pad_sequence, pad_packed_sequence
from torchrua.reduction import reduce_packed_indices, reduce_sequence, reduce_padded_indices, reduce_catted_indices
...
def reduce_catted_sequence(token_sizes: Type[draw_token_size_lists],
    ...
    with timer.rua_forward:
        prediction = reduce_sequence(data, indices, op=torch.add)
...
def reduce_packed_sequence(token_sizes: Type[draw_token_size_lists],
    ...
    with timer.rua_forward:
        actual = reduce_sequence(data, indices, op=torch.add)
