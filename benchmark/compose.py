...
from torchrua import compose as rua


@timeit
def compose_catted_sequences(device: Type[draw_devices],
    ...
    with timer.rua_compile:
        reduction_pack = rua.compose_catted_sequences(catted_sequences, device=device)
